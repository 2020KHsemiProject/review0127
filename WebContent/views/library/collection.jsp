...
/************** 콘텐츠 **************/
        ...
        #myLibrary-lnb>li:nth-child(2) {/* lnb:책장 *//* 고정 */padding-left: 15px;}
        #myLibrary-lnb>li:nth-child(3) {
            /* lnb:컬렉션 */
            font-weight: bold;
        }
        #myLibrary-lnb a {
						...
						<div class="row">
							...
							<div class="col-12">
								<ul id="myLibrary-lnb" class="row">
									<li class="col-2"><a href="/views/html/myReviewNote.jsp">리뷰노트</a></li>
									<li class="col-2"><a href="/views/html/bookcase.jsp">책장</a></li>
									<li class="col-2"><a href="/views/html/myCollection.jsp">컬렉션</a></li>
								</ul>
							</div>
						</div>
					</div>
