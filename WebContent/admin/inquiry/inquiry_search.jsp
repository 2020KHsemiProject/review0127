...
<script src="/admin/js/inquiry_search.js"></script>
...
<script>
alert("검색결과가 없습니다.");
location.replace("/selectAllInquiry.ad");
</script>
<%}%>
			...
			<div class="page-container">
				...
				<div class="page-contents">
					<div id="admin_member_board" class="board-wrapper">
						<h3 id="board-title">1대1 문의 검색결과</h3>
						<table class="search">
							<form action="/searchInquiry.ad" method="get" id="search">
								<tr>
									<th>작성일</th>
									
									<td><%if(dateFrom.equals("1990-01-01")){%>
                                <input type="date" name="dateFrom">
                                <%}else{ %>
                                <input type="date" name="dateFrom" value="<%=dateFrom %>"><%} %>
                                 ~ <input type="date" name="dateTill" value="<%=dateTill %>"></td></td>
								</tr>
								<tr>
									<th>키워드 검색</th>
