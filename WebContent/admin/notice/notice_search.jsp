...
<link href="/admin/css/notice_board.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<!-- js 파일 -->
	<script src="/admin/js/notice_search.js"></script>
		...
		<div class="body-container">
			...
			<div class="page-container">
				<div class="page-header">
                    <span class="lnb">
                            <a href="/main.ad"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-house-door-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6.5 10.995V14.5a.5.5 0 0 1-.5.5H2a.5.5 0 0 1-.5-.5v-7a.5.5 0 0 1 .146-.354l6-6a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 .146.354v7a.5.5 0 0 1-.5.5h-4a.5.5 0 0 1-.5-.5V11c0-.25-.25-.5-.5-.5H7c-.25 0-.5.25-.5.495z"/>
                        <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                      </svg></a> > 게시판 관리 > <a href="/selectAllNotice.ad">공지사항</a> </span>
                </div>
				<div class="page-contents">
					<div id="selectAllNotice" class="board-wrapper">
                        <h3 id="board-title">공지사항 검색결과</h3>
                        <table class="search">
						...
						<a href="/admin/notice/notice_write.jsp" class="insert-btn">글 작성</a>
                        <table class="board">
                            <tr class="head">
                        ...
                        <p></p>
                        <div>
                        <div><form action="/deleteNoticeList.ad" method="get"
									id="deleteNoticeList">
