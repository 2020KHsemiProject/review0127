...
<body>
	...
	<script src="/admin/js/member_search.js"></script>
...
String enrollFrom = request.getParameter("enrollFrom");
String enrollTill = request.getParameter("enrollTill");
String endFrom = request.getParameter("endFrom");
String endTill = request.getParameter("endTill");
		...
		<div class="body-container">
			...
			<div class="page-container">
				...
				<div class="page-contents">
					<div id="/selectAllMember.ad" class="board-wrapper">
						<h3 id="board-title">회원 검색결과</h3>
						<table class="search">
							<form action="/searchMember.ad" method="get" id="search">
								<tr>
									<th>가입일자</th>
									<td>
									<% if(enrollFrom.equals("1990-01-01")){ %>
									<input type="date" name="enrollFrom">
									<%}else{%>
									<input type="date" name="enrollFrom" value="<%=enrollFrom %>">
									<%} %>
									 ~ <input
										type="date" name="enrollTill" value="<%=enrollTill %>"></td>
									<th>탈퇴일자</th>
									<td>
									<input type="date" name="endFrom" value="<%=endFrom %>"> ~ 
									<input type="date" name="endTill" value="<%=endTill %>">
									</td>
								</tr>
								<tr>
									<th>조건 검색</th>
