...
<link href="/admin/css/faq_write.css" rel="stylesheet" type="text/css">
			...
			<div class="page-container">
				<div class="page-header">
					<span class="lnb"> <a href="/admin/main_page.jsp"><svg
						...
						> 게시판관리 <a href="/selectAllFAQ.ad"
						style="font-decoration: none; color: black;"> > 공지사항 > </a><a
						href="/admin/faq/faq_write.jsp" style="color: blue;">FAQ
							작성</a></span>
				</div>
				<div class="page-contents">
					<h3>FAQ 작성</h3>
					<!-- table -->
					<form method="post" action="/insertFAQ.ad">
						<table>
							<tr>
