...
public class ReviewSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(keyword.equals("")) { //키워드없음
				...
				rl = new ReviewSearchService().searchReview(currentPage,dateFrom,dateTill);
				...
				rl = new ReviewSearchService().searchReview(currentPage,category,keyword,dateFrom,dateTill);
		...
		RequestDispatcher view = request.getRequestDispatcher("/admin/review/review_search_fail.jsp");
		view.forward(request, response);	
