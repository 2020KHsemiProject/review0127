...
import rw.admin.faq.model.service.FAQSearchService;
...
public class FAQSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(keyword.equals("")) { //키워드없음
				...
				fl = new FAQSearchService().searchFAQ(currentPage,dateFrom,dateTill);
				...
				fl = new FAQSearchService().searchFAQ(currentPage,category,keyword,dateFrom,dateTill);
		...
		RequestDispatcher view = request.getRequestDispatcher("/admin/faq/faq_search.jsp");
		...
		RequestDispatcher view = request.getRequestDispatcher("/admin/faq/faq_search_fail.jsp");
		view.forward(request, response);	
